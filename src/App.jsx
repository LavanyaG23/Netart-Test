  ...
  return (
    <div className="app">
      ...
      <div className="centered-content">
        <p>CHEMICALS & PROCESS<span>|</span>POWER<span>|</span>WATER & WASTE WATER<span>|</span>OIL & GAS<span>|</span>PHARMA<span>|</span>SUGARS & DISTILLERIES<span>|</span>PAPER & PULP<span>|</span>MARINE & DEFENCE<span>|</span>METAL & MINING<span>|</span>FOOD & BEVERAGE<span>|</span>PETROCHEMICAL & REFINERIES<span>|</span>SOLAR<span>|</span>BUILDING<span>|</span>HVAC<span>|</span>FIRE FIGHTING<span>|</span>AGRICULTURE & RESIDENTIAL</p>
      </div>
      ...
      <div className="red-box-container">
        <div className="red-box">
          <div className='redbox1'>
            ...
            <div>
              <p className='text1'>Toll free <b>1800 200 1234</b></p>
            </div>
          </div>
          ...
          <div className='redbox2'>
            ...
            <div>
              <a className='text2' href="https://www.facebook.com/cripumps" target='_blank'>www.facebook.com/cripumps</a>
            </div>
          </div>
          ...
          <div className='redbox3'>
            ...
            <div>
              <a className='text3' href="https://www.crigroups.com" target="_blank">www.crigroups.com</a>
            </div>
          </div>
        </div>
      </div>
